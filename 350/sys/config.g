...
M584 X0.4 Y0.5 Z0.0:0.1:0.2:0.3 E121.0
M350 X16 Y16 Z16 E16 I1								; configure microstepping with interpolation
M92 X160.00 Y160.00 Z400.00 E404						; set steps per mm
...
M671 X-65:-65:420:340 Y-20:450:450:-20 S20      ; Define Z belts locations (Front_Left, Back_Left, Back_Right, Front_Right)
                                            ...
                                            ; S20 - 20 mm spacing
M557 X30:320 Y30:320 P5                     ; Define bed mesh grid (inductive probe, positions include the Y offset!)
...
; CHAMBER SENSOR 
; ==================================
M308 S10 P"io7.out+io7.in" Y"dht22" A"Enc Temp[C]"
...
M106 P2 H3 L0.2 T35:55 C"Electronics Fan"
M950 F3 C"!out5+out5.tach"							  ; Noctau 12v PWM 4 wire on out 3
M106 P3 H3 L0.2 T25:45 C"Turbo Electronics Fan"
; =====================================
; Lights
; =====================================
M950 F4 C"0.out3" Q500
